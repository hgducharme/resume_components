...
\noindent
\textbf{HighlightTools} \hfill July 2024 - Present\\
\textit{Founder - \url{https://highlight-tools.pages.dev/}}
\begin{itemize}
    \item Building a web application to efficiently remove duplicate Kindle annotations from the Kindle annotation text file
    \item Performing full-stack web development using Python, Django, HTML, CSS, and JavaScript
    \item Implemented plagarism detection algorithms to identify and eliminate duplicate annotations
\end{itemize}
}
